...
import { LogIn, ArrowRight, AlertCircle, Lock, Mail, Loader2 } from 'lucide-react'
...
function LoginPage() {
  ...
  const { user, login, isLoggingIn, isAuthenticated } = useAuth()
      ...
      <div className="w-full max-w-md bg-white border border-brand-border rounded-2xl p-6 sm:p-8 shadow-sm animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black font-display text-brand-dark tracking-tight">
            Sign In to FoxelSignal
          </h1>
          <p className="text-xs text-gray-500 font-mono mt-1">
            Access quant strategy models and terminal signals
          </p>
        </div>
